---
title: Run UBOS in an AArch64 Linux container
weight: 440
---
...
{{% note %}}
You can run UBOS in an Aarch64 Linux container on Apple Silicon, such as from within
a UTM or Parallels virtual machine.
{{% /note %}}
...
1. When the boot process is finished, log in as user ``root``
   (for password, see {{% pageref "/docs/operation/faq-howto-troubleshooting/" %}}).
